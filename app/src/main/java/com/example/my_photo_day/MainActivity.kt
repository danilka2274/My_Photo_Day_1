...
import com.example.my_photo_day.databinding.ActivityMainBinding
    ...
    */
    private fun init() {
        ...
        themeStorage.themeID.let {
            when (it) {
                0 -> setTheme(R.style.Theme_My_Photo_Day_NoActionBar)
                1 -> setTheme(R.style.Theme_My_Photo_Day_Orange_NoActionBar)
            }
        }
    }
